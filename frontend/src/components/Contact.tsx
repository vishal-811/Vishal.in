             ...
             <div>
                <h3 className={`${theme==='dark'?'text-white':'text-black'} text-2xl md:text-4xl tracking-tight font-bold`}>Reach me out</h3>
                 ...
                 <div className={`border  ${theme==='dark'?'border-blue-300  bg-blue-300 bg-opacity-50':'border-green-300 bg-blue-50'} mt-12 w-full rounded-lg p-6 my-4`}>
                      ...
                      <p className={`${theme==='dark'?'text-gray-200':'text-gray-500'} text-lg md:text-xl tracking-tighter my-1 mb-4`}>Drop your message and let's discuss about your project.</p>
                      <a href="https://wa.me/916006275359?text=I want to work on a project" target="_blank" className={`mt-4 px-4 text-center w-full font-bold h-8 text-gray-900 py-1 rounded ${theme==='dark'?'border-blue-300':'border-green-300'} bg-green-500 `} type="submit">Chat on WhatsApp</a>
